...
//mult_24bit unsigned_mul_24(.data_a({bitorA,A[22:0]}), .data_b({bitorB,B[22:0]}), .data_o(product));
unsigned_mul_24 my_unsigned_mul_24(.a({bitorA,A[22:0]}),.b({bitorB,B[22:0]}),.out(product));
...
assign Underflow =  (A[30:23]==8'b0000_0000 || B[30:23]==8'b0000_0000) ? 1'b1 : ~sign_carry;
